...
import com.eqtron.Management.System.rest.FournisseurRest;
...
public class FournisseurRestImpl implements FournisseurRest {
    ...
    public ResponseEntity<List<Fournisseur>> getAllfournisseur(String filtervalue) {
        ...
        try {
            return fournisseurService.getAllfournisseur(filtervalue);
    ...
    public ResponseEntity<String> addNewFournisseur(Map<String, String> requestmap) {
        try {
            return fournisseurService.addnewFournisseur(requestmap);
